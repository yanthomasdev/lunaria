...
This command will automatically create a new `lunaria.config` file, include an easy-to-use `lunaria` command to your `package.json`, and add all the necessary dependencies for your specific project.

:::note
The `create-lunaria` setup wizard currently does not walk you through configuring the `lunaria.config` file. Visit the Reference section to manually proceed instead.
:::
