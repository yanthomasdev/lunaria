...
<LinkCard
	title="Tracking"
	description="Learn more on how Lunaria's tracking works and how to take over when necessary."
	href="/tracking/"
/>
...
<CardGrid>
	<LinkCard
		...
		description="Learn how to add custom styles, components, and more to your dashboard."
		href="/features/dashboard-customization/"
	/>
	<LinkCard
		title="Workflow"
		description="Learn our recommended workflow to improve your contributors' and maintainers' experience."
		href="/workflow/"
	/>
</CardGrid>
